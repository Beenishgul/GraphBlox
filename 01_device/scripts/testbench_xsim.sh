...
# Set xvlog options
xvlog_opts="--incr --relax -L uvm -f ${app_directory}/${kernel_name}_scripts/${kernel_name}_filelist_xsim.f  -i ${app_directory}/${kernel_name}_IP/iob_cache/iob_include -L xilinx_vip --sv"
