...
then
   ...
   config+="sp=${KERNEL_NAME}_1.buffer_0:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_1:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_2:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_3:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_4:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_5:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_6:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_7:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_8:HBM[0:3]\n"
   config+="sp=${KERNEL_NAME}_1.buffer_9:HBM[0:3]\n"
