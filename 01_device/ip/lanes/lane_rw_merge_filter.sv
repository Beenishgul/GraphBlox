...
// File   : lane_rw_merge_filter.sv
// Create : 2023-01-23 16:17:05
// Revise : 2023-06-13 23:57:33
...
// Wires and Variables
// --------------------------------------------------------------------------------------
    logic areset_lane_rw_merge_filter;
    logic areset_fifo                ;
...
// --------------------------------------------------------------------------------------
    always_ff @(posedge ap_clk) begin
        areset_lane_rw_merge_filter <= areset;
        areset_fifo                 <= areset;
    end
...
// --------------------------------------------------------------------------------------
    always_ff @(posedge ap_clk) begin
        if (areset_lane_rw_merge_filter) begin
...
endmodule : lane_rw_merge_filter