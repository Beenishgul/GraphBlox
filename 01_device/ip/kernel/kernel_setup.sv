...
// --------------------------------------------------------------------------------------
    ...
    logic fifo_MemoryPacketResponse_setup_signal;
...
// --------------------------------------------------------------------------------------
    always_ff @(posedge ap_clk) begin
        if (setup_areset) begin
            ...
            fifo_setup_signal              <= engine_serial_read_fifo_setup_signal | fifo_MemoryPacketRequest_setup_signal |fifo_MemoryPacketResponse_setup_signal;
