...
module bundle_engines #(
    ...
    input  FIFOStateSignalsInput  fifo_response_out_signals_in ,
    output FIFOStateSignalsOutput fifo_response_out_signals_out,
...
// --------------------------------------------------------------------------------------
    MemoryPacketPayload    fifo_response_out_din             ;
    MemoryPacketPayload    fifo_response_out_dout            ;
    FIFOStateSignalsInput  fifo_response_out_signals_in_reg  ;
    FIFOStateSignalsInput  fifo_response_out_signals_in_int  ;
    FIFOStateSignalsOutput fifo_response_out_signals_out_int ;
    logic                  fifo_response_out_setup_signal_int;
...
// --------------------------------------------------------------------------------------
    always_ff @(posedge ap_clk) begin
        if (areset_bundle_engines) begin
            ...
            fifo_response_out_signals_in_reg <= 0;
            ...
            fifo_response_out_signals_in_reg <= fifo_response_out_signals_in;
...
// --------------------------------------------------------------------------------------
    always_ff @(posedge ap_clk) begin
        if (areset_bundle_engines) begin
            fifo_setup_signal  <= 1;
            request_out.valid  <= 0;
            response_out.valid <= 0;
        end
        else begin
            fifo_setup_signal  <= fifo_request_in_setup_signal_int | fifo_response_in_setup_signal_int | fifo_request_out_setup_signal_int | fifo_response_out_setup_signal_int;
    ...
    always_ff @(posedge ap_clk) begin
        ...
        fifo_response_out_signals_out <= fifo_response_out_signals_out_int;
...
// --------------------------------------------------------------------------------------
    // FIFO is resetting
    assign fifo_response_out_setup_signal_int = fifo_response_out_signals_out_int.wr_rst_busy | fifo_response_out_signals_out_int.rd_rst_busy;

    // Push
    assign fifo_response_out_signals_in_int.wr_en = 1'b0;
    assign fifo_response_out_din                  = 0;

    // Pop
    assign fifo_response_out_signals_in_int.rd_en = ~fifo_response_out_signals_out_int.empty & fifo_response_out_signals_in_reg.rd_en;
    assign response_out_int.valid                 = fifo_response_out_signals_out_int.valid;
    assign response_out_int.payload               = fifo_response_out_dout;
    ...
    xpm_fifo_sync_wrapper #(
        ...
        .clk         (ap_clk                                        ),
        .srst        (areset_fifo                                   ),
        .din         (fifo_response_out_din                         ),
        .wr_en       (fifo_response_out_signals_in_int.wr_en        ),
        .rd_en       (fifo_response_out_signals_in_int.rd_en        ),
        .dout        (fifo_response_out_dout                        ),
        .full        (fifo_response_out_signals_out_int.full        ),
        .almost_full (fifo_response_out_signals_out_int.almost_full ),
        .empty       (fifo_response_out_signals_out_int.empty       ),
        .almost_empty(fifo_response_out_signals_out_int.almost_empty),
        .valid       (fifo_response_out_signals_out_int.valid       ),
        .prog_full   (fifo_response_out_signals_out_int.prog_full   ),
        .prog_empty  (fifo_response_out_signals_out_int.prog_empty  ),
        .wr_rst_busy (fifo_response_out_signals_out_int.wr_rst_busy ),
        .rd_rst_busy (fifo_response_out_signals_out_int.rd_rst_busy )
    );
