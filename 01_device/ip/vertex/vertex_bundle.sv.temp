...
module vertex_bundle #(
    ...
    input  MemoryPacket                vertex_bundle_mem_resp_in,
...
// --------------------------------------------------------------------------------------
    always_ff @(posedge ap_clk) begin
        if (vertex_bundle_areset) begin
            ...
            vertex_bundle_mem_resp_din.valid <= vertex_bundle_mem_resp_in.valid;
    ...
    always_ff @(posedge ap_clk) begin
        vertex_bundle_mem_resp_din.payload <= vertex_bundle_mem_resp_in.payload;
    end
...
// --------------------------------------------------------------------------------------
    ...
    always_ff @(posedge ap_clk) begin
        ...
        vertex_bundle_mem_req_out.payload <= vertex_bundle_mem_req_dout.payload;
    end
...
// FIFO cache Ready
// --------------------------------------------------------------------------------------
    assign fifo_MemoryPacketRequest_vertex_bundle_signal  = req_fifo_out_signals_reg.wr_rst_busy | req_fifo_out_signals_reg.rd_rst_busy;
    assign fifo_MemoryPacketResponse_vertex_bundle_signal = resp_fifo_out_signals_reg.wr_rst_busy | resp_fifo_out_signals_reg.rd_rst_busy;
...
// --------------------------------------------------------------------------------------
    ...
    assign vertex_bundle_mem_resp_dout.valid = resp_fifo_out_signals_reg.valid;
...
// --------------------------------------------------------------------------------------
    assign req_fifo_in_signals_reg.wr_en    = vertex_bundle_mem_req_din.valid;
    assign vertex_bundle_mem_req_dout.valid = req_fifo_out_signals_reg.valid;
