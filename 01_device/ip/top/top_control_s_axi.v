...
//------------------------Parameter----------------------
    localparam
        ...
        ADDR_IER                       = 7'h08,
        ADDR_ISR                       = 7'h0c,
        ADDR_BUFFER_0_DATA_0           = 7'h10,
        ADDR_BUFFER_0_DATA_1           = 7'h14,
        ADDR_BUFFER_0_CTRL             = 7'h18,
        ADDR_BUFFER_1_DATA_0           = 7'h1c,
        ADDR_BUFFER_1_DATA_1           = 7'h20,
        ADDR_BUFFER_1_CTRL             = 7'h24,
        ADDR_BUFFER_2_DATA_0           = 7'h28,
        ADDR_BUFFER_2_DATA_1           = 7'h2c,
        ADDR_BUFFER_2_CTRL             = 7'h30,
        ADDR_BUFFER_3_DATA_0           = 7'h34,
        ADDR_BUFFER_3_DATA_1           = 7'h38,
        ADDR_BUFFER_3_CTRL             = 7'h3c,
        ADDR_BUFFER_4_DATA_0           = 7'h40,
        ADDR_BUFFER_4_DATA_1           = 7'h44,
        ADDR_BUFFER_4_CTRL             = 7'h48,
        ADDR_BUFFER_5_DATA_0           = 7'h4c,
        ADDR_BUFFER_5_DATA_1           = 7'h50,
        ADDR_BUFFER_5_CTRL             = 7'h54,
        ADDR_BUFFER_6_DATA_0           = 7'h58,
        ADDR_BUFFER_6_DATA_1           = 7'h5c,
        ADDR_BUFFER_6_CTRL             = 7'h60,
        ADDR_BUFFER_7_DATA_0           = 7'h64,
        ADDR_BUFFER_7_DATA_1           = 7'h68,
        ADDR_BUFFER_7_CTRL             = 7'h6c,
        ADDR_BUFFER_8_DATA_0           = 7'h70,
        ADDR_BUFFER_8_DATA_1           = 7'h74,
        ADDR_BUFFER_8_CTRL             = 7'h78,
        ADDR_BUFFER_9_DATA_0           = 7'h7c,
        ADDR_BUFFER_9_DATA_1           = 7'h80,
        ADDR_BUFFER_9_CTRL             = 7'h84,
        WRIDLE                         = 2'd0,
        WRDATA                         = 2'd1,
        WRRESP                         = 2'd2,
        WRRESET                        = 2'd3,
