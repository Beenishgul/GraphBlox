...
////////////////////////////////////////////////////////////////////////////
    ...
    parameter IOB_AXI_DATA_W                = IOB_BE_ADDR_W;
    parameter IOB_AXI_ID_W                  = 1, //AXI ID (identification) width
    parameter IOB_AXI_LEN_W                 = 8, //AXI ID burst length (log2)
    parameter [IOB_AXI_ID_W-1:0] IOB_AXI_ID = 0, //AXI ID value
    //Controller's options
    parameter IOB_CTRL_CACHE                = 0; //Adds a Controller to the cache, to use functions sent by the master or count the hits and misses
    parameter IOB_CTRL_CNT                  = 0; //Counters for Cache Hits and Misses - Disabling this and previous, the Controller only store the buffer states and allows cache invalidation
