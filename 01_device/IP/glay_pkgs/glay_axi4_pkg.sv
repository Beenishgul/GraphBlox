...
typedef struct packed {
  ...
  logic [IOB_AXI_ID_W-1:0]        arid;    // Address read channel ID
  ...
  logic [IOB_AXI_ID_W-1:0]          bid         ; // Write response channel ID
  ...
  typedef struct packed {
    ...
    logic [IOB_AXI_ID_W-1:0]                  awid;    // Address write channel ID
