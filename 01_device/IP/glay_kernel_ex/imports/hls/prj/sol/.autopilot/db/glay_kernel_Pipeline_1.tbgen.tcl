set moduleName glay_kernel_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {glay_kernel_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ m00_axi int 512 regular {axi_master 0}  }
	{ sext_ln71 int 58 regular  }
	{ m00_axi_input_buffer int 32 regular {array 8192 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m00_axi", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "graph_csr_struct","offset": { "type": "dynamic","port_name": "graph_csr_struct","bundle": "control"},"direction": "READWRITE"},{"cName": "vertex_out_degree","offset": { "type": "dynamic","port_name": "vertex_out_degree","bundle": "control"},},{"cName": "vertex_in_degree","offset": { "type": "dynamic","port_name": "vertex_in_degree","bundle": "control"},},{"cName": "vertex_edges_idx","offset": { "type": "dynamic","port_name": "vertex_edges_idx","bundle": "control"},},{"cName": "edges_array_weight","offset": { "type": "dynamic","port_name": "edges_array_weight","bundle": "control"},},{"cName": "edges_array_src","offset": { "type": "dynamic","port_name": "edges_array_src","bundle": "control"},},{"cName": "edges_array_dest","offset": { "type": "dynamic","port_name": "edges_array_dest","bundle": "control"},},{"cName": "auxiliary_1","offset": { "type": "dynamic","port_name": "auxiliary_1","bundle": "control"},},{"cName": "auxiliary_2","offset": { "type": "dynamic","port_name": "auxiliary_2","bundle": "control"},}]}]} , 
 	{ "Name" : "sext_ln71", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln71 sc_in sc_lv 58 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln71", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln71", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln71 { ap_none {  { sext_ln71 in_data 0 58 } } }
