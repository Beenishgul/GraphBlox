...
entity glay_kernel_glay_kernel_Pipeline_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of glay_kernel_glay_kernel_Pipeline_3 is 
...
begin
    ...
    ap_block_state3_io_assign_proc : process(m_axi_m00_axi_WREADY, empty_31_reg_225_pp0_iter1_reg)
    begin
                ap_block_state3_io <= ((empty_31_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (m_axi_m00_axi_WREADY = ap_const_logic_0));
    end process;
    ...
    m00_axi_blk_n_W_assign_proc : process(ap_enable_reg_pp0_iter2, m_axi_m00_axi_WREADY, empty_31_reg_225_pp0_iter1_reg, ap_block_pp0_stage0)
    begin
    ...
    m_axi_m00_axi_WVALID_assign_proc : process(ap_enable_reg_pp0_iter2, empty_31_reg_225_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
