...
module glay_kernel_glay_kernel_Pipeline_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state3_io = ((empty_31_reg_225_pp0_iter1_reg == 1'd1) & (m_axi_m00_axi_WREADY == 1'b0));
end
...
assign empty_29_fu_184_p3 = ((empty_31_reg_225_pp0_iter1_reg[0:0] == 1'b1) ? 480'd0 : tmp_2_fu_177_p3);
...
endmodule //glay_kernel_glay_kernel_Pipeline_3
