...
module glay_kernel_glay_kernel_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            shiftreg9_fu_58 <= {{ap_phi_mux_empty_33_phi_fu_93_p4[511:32]}};
        end
    end
end
...
always @ (*) begin
    ap_predicate_op25_read_state2 = ((empty_36_reg_209 == 1'd1) & (exitcond65_reg_205 == 1'd0));
end
...
assign m00_axi_input_buffer_d0 = ap_phi_mux_empty_33_phi_fu_93_p4[31:0];
...
endmodule //glay_kernel_glay_kernel_Pipeline_1
