...
module glay_kernel_example_vadd #(
...
glay_kernel_example_axi_read_master #(
...
// AXI4 Write Master
glay_kernel_example_axi_write_master #(
  .C_M_AXI_ADDR_WIDTH  ( C_M_AXI_ADDR_WIDTH    ) ,
  .C_M_AXI_DATA_WIDTH  ( C_M_AXI_DATA_WIDTH    ) ,
  .C_XFER_SIZE_WIDTH   ( C_XFER_SIZE_WIDTH     ) ,
...
endmodule : glay_kernel_example_vadd
