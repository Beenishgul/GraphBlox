...
0x00000104 // entry 5    cacheline 0    offset 5    --  5  - STRUCT_ENGINE_DATA | CMD_MEM_READ | id moddule | id engine
...
0x00000104 // entry 18   cacheline 1    offset 2    --  5  - STRUCT_ENGINE_DATA | CMD_MEM_READ | id moddule | id engine
...
0x00010401 // entry 58   cacheline 3    offset 10   --  6  - if   | Cast to first 3 Lanes in next bundle | BUNDLE-0 | VERTEX-0
0x00010401 // entry 59   cacheline 3    offset 11   --  7  - else | Cast to first 3 Lanes in next bundle | BUNDLE-0 | VERTEX-0
...
// --------------------------------------------------------------------------------------
0x0000001D // entry 88   cacheline 5    offset 8    --  0  - Increment/Decrement
...
0x00000001 // entry 117  cacheline 7    offset 5    --  4  - break_flag | continue_flag | ternary_flag | conditional_flag
