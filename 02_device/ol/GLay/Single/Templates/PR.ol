...
// --------------------------------------------------------------------------------------
0x0000000D // entry 6    cacheline 0    offset 6    -- //  0  - Increment | Decrement | mode_sequence | mode_buffer | mode_break | mode_filter
0x00000000 // entry 7    cacheline 0    offset 7    -- //  1  - Index_start
0x00000000 // entry 8    cacheline 0    offset 8    -- //  2  - Index_end
0x00000001 // entry 9    cacheline 0    offset 9    -- //  3  - Stride
0x80000002 // entry 10   cacheline 0    offset 10   -- //  4  - Shift direction 1-left 0-right | (granularity - log2 value for shifting)
0x00000102 // entry 11   cacheline 0    offset 11   -- //  5  - CMD_MEM_READ | STRUCT_ENGINE_DATA | id moddule | id engine
0x01010801 // entry 12   cacheline 0    offset 12   -- //  6  - route  | Cast to first 3 Lanes in next bundle | BUNDLE-0 | VERTEX-0
0x00000000 // entry 13   cacheline 0    offset 13   -- //  7  - BUFFER Array Pointer LHS
0x00000000 // entry 14   cacheline 0    offset 14   -- //  8  - BUFFER Array Pointer RHS
0x00000033 // entry 15   cacheline 0    offset 15   -- //  9  - BUFFER size
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
// Name ENGINE_READ_WRITE   ID 6    mapping 1    cycles 13   buffer_8-auxiliary_2 ( graph->num_auxiliary_2 )-( graph->num_auxiliary_2 * 2 )
// --------------------------------------------------------------------------------------
...
0x00000102 // entry 64   cacheline 4    offset 0    -- //  5  - CMD_MEM_READ | STRUCT_ENGINE_DATA | id moddule | id engine
0x01010801 // entry 65   cacheline 4    offset 1    -- //  6  - route  | Cast to first 3 Lanes in next bundle | BUNDLE-0 | VERTEX-0
...
0x00000033 // entry 68   cacheline 4    offset 4    -- //  9  - BUFFER size
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
// Name ENGINE_READ_WRITE   ID 10   mapping 1    cycles 13   buffer_7-auxiliary_1 ( graph->num_auxiliary_1 )-( graph->num_auxiliary_1 * 2 )
// --------------------------------------------------------------------------------------
0x00000000 // entry 70   cacheline 4    offset 6    -- //  0  - Increment/Decrement
0x00000000 // entry 71   cacheline 4    offset 7    -- //  1  - Index_start
0x00000033 // entry 72   cacheline 4    offset 8    -- //  2  - Index_end
...
0x00000102 // entry 75   cacheline 4    offset 11   -- //  5  - STRUCT_ENGINE_DATA | CMD_MEM_READ | id moddule | id engine
0x00010401 // entry 76   cacheline 4    offset 12   -- //  6  - route  | Cast to first 3 Lanes in next bundle | BUNDLE-0 | VERTEX-0
...
0x00008412 // entry 82   cacheline 5    offset 2    -- //  12 - ops_mask
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
