...
0x00000000 // entry 13   cacheline 0    offset 13   -- // entry_7    cacheline[  0][ 7] <32b>: array_pointer[0:31]=0x00000000
0x00000000 // entry 14   cacheline 0    offset 14   -- // entry_8    cacheline[  0][ 8] <32b>: array_pointer[0:31]=0x00000000
0x00000000 // entry 15   cacheline 0    offset 15   -- // entry_9    cacheline[  0][ 9] <32b>: array_size[0:31]=0x00000000
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
...
0x00000081 // entry 22   cacheline 1    offset 6    -- // entry_5    cacheline[  0][ 5] <29b>: cmd[0:6]=CMD_INVALID || buffer[7:12]=STRUCT_INVALID || id_module[13:20]=0x00 || id_engine[21:28]=0x00
...
0x00000000 // entry 24   cacheline 1    offset 8    -- // entry_7    cacheline[  0][ 7] <32b>: array_pointer[0:31]=0x00000000
0x00000000 // entry 25   cacheline 1    offset 9    -- // entry_8    cacheline[  0][ 8] <32b>: array_pointer[0:31]=0x00000000
0x00000000 // entry 26   cacheline 1    offset 10   -- // entry_9    cacheline[  0][ 9] <32b>: array_size[0:31]=0x00000000
0x00000000 // entry 27   cacheline 1    offset 11   -- // entry_10   cacheline[  0][10] < 4b>: const_mask[0:3]=0x0
0x00000000 // entry 28   cacheline 1    offset 12   -- // entry_11   cacheline[  0][11] <32b>: const_value[0:31]=0x00000000
0x00000000 // entry 29   cacheline 1    offset 13   -- // entry_12   cacheline[  0][12] <16b>: ops_mask[0:15]=0x00
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
// Name ENGINE_MERGE_DATA   ID 4    mapping 4    cycles 2    None-None ( 0 )-( 0 )
// --------------------------------------------------------------------------------------
0x00000000 // entry 30   cacheline 1    offset 14   -- // entry_0    cacheline[  0][ 0] < 4b>: merge_mask[0:3]=0x0
...
0x00000000 // entry 61   cacheline 3    offset 13   -- // entry_2    cacheline[  0][ 2] <32b>: index_end[0:31]=0x00000000
0x00000000 // entry 62   cacheline 3    offset 14   -- // entry_3    cacheline[  0][ 3] <32b>: stride[0:31]=0x00000000
0x00000000 // entry 63   cacheline 3    offset 15   -- // entry_4    cacheline[  0][ 4] <32b>: shift.amount[0:30]=0 || shift.direction[31:31]=0
0x00000081 // entry 64   cacheline 4    offset 0    -- // entry_5    cacheline[  0][ 5] <29b>: cmd[0:6]=CMD_INVALID || buffer[7:12]=STRUCT_INVALID || id_module[13:20]=0x00 || id_engine[21:28]=0x00
0x00000000 // entry 65   cacheline 4    offset 1    -- // entry_6    cacheline[  0][ 6] <32b>: id_cu[0:7]=0x00 || id_bundle[8:15]=0x00 || id_lane[16:23]=0x00 || id_buffer[24:31]=0x00
0x00000000 // entry 66   cacheline 4    offset 2    -- // entry_7    cacheline[  0][ 7] <32b>: array_pointer[0:31]=0x00000000
0x00000000 // entry 67   cacheline 4    offset 3    -- // entry_8    cacheline[  0][ 8] <32b>: array_pointer[0:31]=0x00000000
0x00000000 // entry 68   cacheline 4    offset 4    -- // entry_9    cacheline[  0][ 9] <32b>: array_size[0:31]=0x00000000
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
...
0x00000081 // entry 75   cacheline 4    offset 11   -- // entry_5    cacheline[  0][ 5] <29b>: cmd[0:6]=CMD_INVALID || buffer[7:12]=STRUCT_INVALID || id_module[13:20]=0x00 || id_engine[21:28]=0x00
...
0x00000000 // entry 77   cacheline 4    offset 13   -- // entry_7    cacheline[  0][ 7] <32b>: array_pointer[0:31]=0x00000000
0x00000000 // entry 78   cacheline 4    offset 14   -- // entry_8    cacheline[  0][ 8] <32b>: array_pointer[0:31]=0x00000000
0x00000000 // entry 79   cacheline 4    offset 15   -- // entry_9    cacheline[  0][ 9] <32b>: array_size[0:31]=0x00000000
0x00000000 // entry 80   cacheline 5    offset 0    -- // entry_10   cacheline[  0][10] < 4b>: const_mask[0:3]=0x0
0x00000000 // entry 81   cacheline 5    offset 1    -- // entry_11   cacheline[  0][11] <32b>: const_value[0:31]=0x00000000
0x00000000 // entry 82   cacheline 5    offset 2    -- // entry_12   cacheline[  0][12] <16b>: ops_mask[0:15]=0x00
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
// Name ENGINE_FORWARD_DATA ID 11   mapping 6    cycles 1    None-None ( 0 )-( 0 )
// --------------------------------------------------------------------------------------
0x00000000 // entry 83   cacheline 5    offset 3    -- // entry_0    cacheline[  0][ 0] < 4b>: hops[0:3]=0x0
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
// -->  Template.Single.PR  <-- 
