...
// CU BUFFER -> AXI Kernel Cache
      m{0:02d}_axi_cu_buffer_mid{2}x{3}_fe{4}x{5}_wrapper inst_cu_buffer_l1 (
        .ap_clk                   (ap_clk                                 ),
        .areset                   (areset_cu_channel[{1}]                   ),
        .descriptor_in            (cu_channel_descriptor[{1}]               ),
        .request_in               (cu_channel_request_in[{1}]               ),
...
logic [M{0:02d}_AXI4_MID_DATA_W-1:0] write_transaction_length_in   ;
logic [M{0:02d}_AXI4_MID_ADDR_W-1:0] write_transaction_offset_in   ;
logic [M{0:02d}_AXI4_MID_DATA_W-1:0] write_transaction_tdata_in    ;
logic [M{0:02d}_AXI4_MID_DATA_W-1:0] write_transaction_tdata_in_reg;
...
iob_cache_axi #(
  ...
  .AXI_ADDR_W          (M{0:02d}_AXI4_MID_ADDR_W                           ),
  .AXI_DATA_W          (M{0:02d}_AXI4_MID_DATA_W                           ),
  .SRAM_AXI_SRAM_MODE(M{0:02d}_AXI4_MID_SRAM_WRITE_BACK_ALLOCATE_READS_WRITES)
) inst_iob_cache_axi (
  .iob_avalid_i(cache_request_mem.iob.valid                                                           ),
  .iob_addr_i  (cache_request_mem.iob.addr [SRAM_CTRL_CNT+M{0:02d}_AXI4_FE_ADDR_W-1:$clog2(M{0:02d}_AXI4_FE_DATA_W/8)]),
  .iob_wdata_i (cache_request_mem.iob.wdata                                                           ),
  .iob_wstrb_i (cache_request_mem.iob.wstrb                                                           ),
  .iob_rdata_o (cache_response_mem.iob.rdata                                                          ),
  .iob_rvalid_o(cache_response_mem.iob.valid                                                          ),
