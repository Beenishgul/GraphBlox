...
def main(params_sh_dir):
    ...
    cfg_file_name = os.path.join(app_dir_active, utils_dir_active, f"{kernel_name}_filelist_package.src.f")
    cfg_file_name_vh = os.path.join(app_dir_active, utils_dir_active, f"{kernel_name}_filelist_package.vh.f")
