...
for i, algorithm in enumerate(algorithms):
    ...
    axes[i].bar(bar_positions_1, table_1_algo_times, bar_width, alpha=opacity, color=colors[0], edgecolor='black', linewidth=1.5, label='Table 1')
    axes[i].bar(bar_positions_2, table_2_algo_times, bar_width, alpha=opacity, color=colors[1], edgecolor='black', linewidth=1.5, label='Table 2')
    axes[i].bar(bar_positions_3, table_3_algo_times, bar_width, alpha=opacity, color=colors[2], edgecolor='black', linewidth=1.5, label='Table 3')
