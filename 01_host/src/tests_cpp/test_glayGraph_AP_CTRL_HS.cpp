...
main (int argc, char **argv)
{
    ...
    arguments->glayHandle = setupGLAYDevice(arguments->glayHandle, arguments->device_index, arguments->xclbin_path, arguments->overlay_path, arguments->kernel_name, 1, TRUE, 122);
    ...
    glayGraphCSRxrtBufferHandlePerBank = setupGLAYGraphCSRCtrlHs(arguments->glayHandle, graph, graphAuxiliary, bank_grp_idx);
