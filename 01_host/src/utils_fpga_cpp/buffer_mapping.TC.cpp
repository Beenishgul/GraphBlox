...
// --------------------------------------------------------------------------------------
   ...
   // --  7  - Array_Pointer_LHS
    overlay_program[7] = xrt_buffer_device[5];
   // --  8  - Array_Pointer_RHS
    overlay_program[8] = xrt_buffer_device[5] >> 32;
   // --  9  - Array_size
    overlay_program[9] = ( graph->num_edges )-( 0 );
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------
   ...
   // --  7  - Array_Pointer_LHS
    overlay_program[139] = xrt_buffer_device[8];
   // --  8  - Array_Pointer_RHS
    overlay_program[140] = xrt_buffer_device[8] >> 32;
   // --  9  - Array_size
...
// --------------------------------------------------------------------------------------
   // --  1  - Index_Start
    overlay_program[146] = ( 0 );
   // --  2  - Index_End
    overlay_program[147] = ( graph->num_vertices );
   // --  7  - Array_Pointer_LHS
    overlay_program[152] = xrt_buffer_device[3];
   // --  8  - Array_Pointer_RHS
    overlay_program[153] = xrt_buffer_device[3] >> 32;
   // --  9  - Array_size
    overlay_program[154] = ( graph->num_vertices )-( 0 );
// --------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------
   ...
   // --  7  - Array_Pointer_LHS
    overlay_program[167] = xrt_buffer_device[2];
   // --  8  - Array_Pointer_RHS
    overlay_program[168] = xrt_buffer_device[2] >> 32;
   // --  9  - Array_size
...
// --------------------------------------------------------------------------------------
   ...
   // --  7  - Array_Pointer_LHS
    overlay_program[180] = xrt_buffer_device[3];
   // --  8  - Array_Pointer_RHS
    overlay_program[181] = xrt_buffer_device[3] >> 32;
   // --  9  - Array_size
