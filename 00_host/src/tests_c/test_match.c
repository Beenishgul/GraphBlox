...
// Email  : atmughra@virginia.edu||atmughrabi@gmail.com
// File   : test_match.c
...
main (int argc, char **argv)
{
    ...
    arguments.fnameb = (char *) malloc((strlen("../03_test_graphs/LAW/LAW-enron/graph.bin") + 10) * sizeof(char));
    arguments.fnamel = (char *) malloc((strlen("../03_test_graphs/LAW/LAW-enron/graph_Gorder.labels") + 10) * sizeof(char));

    arguments.fnameb  = strcpy (arguments.fnameb, "../03_test_graphs/LAW/LAW-enron/graph.bin");
    arguments.fnamel  = strcpy (arguments.fnamel, "../03_test_graphs/LAW/LAW-enron/graph_Gorder.labels");
    ...
    {
        for(arguments.datastructure = 0 ; arguments.datastructure < 1; arguments.datastructure++)
        {
            ...
            while(arguments.trials)
            {
                ...
                for(arguments.pushpull = 0 ; arguments.pushpull < 7; arguments.pushpull++)
                {
